angular.module('relatives.services', [])
  .factory( 'Children', function(){
    ...
    // Might use a resource here that returns a JSON array
      ...
      var children = [
        { id:0, name: 'Scruff McGruff Jr', dob: '01/14/2004', interests: [ { name: 'Star Wars', date: '07/13/2010', level: 'high' }, { name: 'dinosaurs', date: '07/13/2000', level: 'high' } ] },
        ...
        { id: 2, name: 'Miss Gurgle', dob: '02/07/2007', interests: [ { name: 'Star Wars', date: '07/13/2010', level: 'high' }, { name: 'dinosaurs', date: '07/13/2000', level: 'high' } ] },
        ...
        { id: 4, name: 'McCAssidy Jane', dob: '04/10/2010', interests: [ { name: 'Star Wars', date: '07/13/2010', level: 'high' }, { name: 'dinosaurs', date: '07/13/2000', level: 'high' } ] },
        { id: 5, name: 'Billy Jean', dob: '06/12/2012', interests: [ { name: 'Star Wars', date: '07/13/2010', level: 'high' }, { name: 'dinosaurs', date: '07/13/2000', level: 'high' } ] },
